    ...
    <div className="group flex flex-col bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg hover:border-[#013d8c]/30 transition-all duration-300">
      ...
      <div className="flex flex-col flex-1 p-4 sm:p-5 gap-2 sm:gap-3">
        <div className="flex items-center justify-between gap-2">
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#013d8c] bg-[#013d8c]/8 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full">
            <svg
        ...
        <Link
          ...
          className="text-sm sm:text-base font-semibold text-gray-900 group-hover:text-[#013d8c] transition-colors leading-snug hover:underline decoration-[#013d8c]/40"
        >
          {item.title}
        </Link>
...
const Conferences: React.FC = () => {
  ...
  return (
    <div className="pb-10">
      <PageTitle>{t('nav.media.conferences')}</PageTitle>
