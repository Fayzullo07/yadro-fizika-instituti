  ...
  const conferences: Conference[] = [
    {
      ...
      date: '2024-03-15',
      location: 'Toshkent',
      description: "Sun'iy intellekt va raqamli texnologiyalar bo'yicha xalqaro ilmiy konferensiya",
    },
    {
      id: 2,
      ...
      date: '2024-05-20',
      location: 'Toshkent',
      description: 'Qurilish va infratuzilma sohasidagi innovatsion yechimlar',
    },
  ];
    ...
    <section className="bg-gray-50 min-h-screen py-12 md:py-16">
      <div className="container mx-auto px-4">
        <SectionHeader
          ...
          subtitle={
            t('pages.conferences.subtitle') || 'Ilmiy konferensiyalar va ilmiy-amaliy anjumanlar'
          }
        />
