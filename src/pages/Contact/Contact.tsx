...
const Contact: React.FC = () => {
  ...
  const address = generalData?.address || "100194, Yangishahar ko'chasi 9A-uy, Toshkent shahar, Yunusobod tumani";
                  ...
                  {phone && (
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href={`tel:${phone.replace(/\s/g, '')}`} className="text-gray-600 hover:text-blue-600 transition-colors">
                          {phone}
                        </a>
                      </div>
                    </div>
                  ...
                  {address && (
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        {address.includes('@') ? (
                          <a href={`mailto:${address}`} className="text-gray-600 hover:text-blue-600 transition-colors">
                            {address}
                          </a>
                        ) : (
