...
export const getFeatures = (t: (key: string) => string): Feature[] => [
  {
    ...
    description:
      ...
      "Biz sun'iy intellekt bo'yicha fundamental va amaliy tadqiqotlar olib boramiz.",
    link: '/research',
    number: '01',
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      ...
      "Bizning maqsadimiz murakkab muammolarni hal qilish uchun sun'iy intellekt va raqamli texnologiyalardan foydalanishdir.",
    link: ABOUT_PATH,
    number: '02',
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      ...
      "Sun'iy intellekt texnologiyalari asosida boshqaruv va ishlab chiqarish jarayonlarini avtomatlashtirish.",
    link: '/projects',
    number: '03',
    icon: (
      <svg
