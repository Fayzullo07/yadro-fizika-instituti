  ...
  const features = [
    {
      ...
      description: t('features.research.description') || 'Biz sun\'iy intellekt bo\'yicha fundamental va amaliy tadqiqotlar olib boramiz. Tadqiqot loyihalarni boshqarish orqali amalga oshiriladi.',
      link: '/research',
      icon: (
    ...
    },
    {
      ...
      description: t('features.about.description') || 'Bizning maqsadimiz murakkab iqtisodiy, ijtimoiy va ilmiy muammolarni hal qilish uchun sun\'iy intellekt va raqamli texnologiyalardan foydalanish imkoniyatlarini topishdir.',
      link: ABOUT_PATH,
      icon: (
        <svg className="w-12 h-12" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <line x1="50" y1="30" x2="50" y2="40" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" />
          <line x1="50" y1="60" x2="50" y2="70" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" />
          <line x1="60" y1="50" x2="70" y2="50" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" />
          <line x1="30" y1="50" x2="40" y2="50" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" />
    ...
    },
    {
      ...
      description: t('features.projects.description') || 'Sun\'iy intellekt texnologiyalari asosida boshqaruv va ishlab chiqarish jarayonlarini avtomatlashtirish bo\'yicha dasturiy mahsulotlarni ishlab chiqish.',
      link: '/projects',
      icon: (
        <svg className="w-12 h-12" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="30" y="30" width="40" height="40" rx="4" stroke="#0ea5e9" strokeWidth="2" fill="none" />
          ...
          <line x1="70" y1="45" x2="70" y2="45" stroke="#0ea5e9" strokeWidth="3" strokeLinecap="round" />
        </svg>
      ),
    },
  ];
