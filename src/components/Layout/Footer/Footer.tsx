        ...
        <div className="grid grid-cols-1 md:grid-cols-10 gap-10">
                ...
                {generalData?.organization_desc && (
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: generalData.organization_desc.length > 150
          ...
          <div className='col-span-2'>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link to={HOME_PATH} className="hover:text-white transition">
                  {t('nav.home') || 'Bosh sahifa'}
                </Link>
              </li>
              <li>
                <Link to={ABOUT_PATH} className="hover:text-white transition">
                  {t('nav.institute.about') || 'Biz haqimizda'}
                </Link>
              </li>
              <li>
                <Link to={CONTACT_PATH} className="hover:text-white transition">
                  {t('nav.contact') || 'Aloqa'}
                </Link>
              </li>
            </ul>
