...
const AddressMapSection2: React.FC = () => {
    ...
    <div className="">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-6">
          {/* Map */}
          <div className="relative h-[500px] lg:col-span-7 lg:h-[300px] rounded overflow-hidden">
            <iframe
          ...
          {/* Info */}
          <div className="flex  gap-3 justify-center lg:col-span-7 space-y-6 text-[#013d8c]">
            {/* Address */}
            <div>
            ...
            <div>
              ...
              <div className=" flex gap-2">
                <div className="bg-white/10 w-[150px] rounded-lg px-4 py-3 border border-[#013d8c]">
                  <p>
                    {t('contact.weekdays') || 'Du-Ju: '} <br />
                    <span className="font-semibold">9:00 – 18:00</span>
                  </p>
                </div>
                <div className="bg-white/10 w-[150px] rounded-lg px-4 py-3 border border-[#013d8c]">
                  <p>
                    {t('contact.lunch') || 'Tushlik: '} <br />
...
export default AddressMapSection2;
